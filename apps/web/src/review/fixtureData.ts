  ...
  iprSites: [
    {
      ...
      targetDistance: 0.31,
      measuredAmount: 0.42,
      computedProposalAmount: 0.11,
      doctorEnteredAmount: null,
      proposedAmount: 0.11,
      status: "needs_review",
      ...
      valueSource: "computed_proposal",
      truthState: "requires_review",
      clinicallyApproved: false,
      limitations: ["Geometric centroid distance is not a clinical IPR recommendation."],
    },
  ],
  attachmentSites: [
    {
      ...
      clinicallyApproved: false,
      limitations: ["Attachment type/dimensions are domain representations, not clinical prescriptions."],
    },
  ],
  clinicalTools: {
    contract_version: "clinical_tools_1.0",
    source_setup_version_id: "fixture-version",
    source_staging_version_id: null,
    adjuncts_proposal_id: "fixture-adjuncts",
    freshness: "current",
    readiness: {
      ipr_measurement: "requires_review",
      ipr_proposal: "requires_review",
      attachment_placement: "requires_review",
      attachment_geometry: "not_available",
      validation: "available",
      setup_binding: "current",
      staging_binding: "unavailable",
      doctor_review_required: true,
      source_geometry: "available",
      notes: ["Fixture clinical-tools shell for UI tests."],
      clinically_approved: false,
    },
    ipr_site_count: 1,
    attachment_site_count: 1,
    measurable_ipr_pairs: 1,
    unavailable_ipr_pairs: 0,
    limitations: ["Engineering fixture — not clinical evidence."],
    clinically_approved: false,
    notes: ["Doctor review is mandatory."],
  },
